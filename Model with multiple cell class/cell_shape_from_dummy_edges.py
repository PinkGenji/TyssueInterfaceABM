...
while t <= t_end:
    ...
    frame_path = f"frames_perimeter/frame_{real_time_hours:.4f}.png"
...
with imageio.get_writer('perimeter_proliferation.mp4', fps=15, format='ffmpeg') as writer:
...
# Save to CSV
df.to_csv("perimeter_proliferation.csv", index=False)
